...
namespace Mymodule\SEO\Controller\Adminhtml\Subscription;
...
class Index extends \Magento\Backend\App\Action {
    ...
    public function execute() {
        ...
        $resultPage->setActiveMenu('Mymodule_SEO::subscription');
    ...
    protected function _isAllowed() {
        return $this->_authorization->isAllowed('Mymodule_SEO::subscription');
    }
